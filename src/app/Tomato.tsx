...
export default function Tomato() {
  ...
  return (
    <div className="glass-panel p-8 rounded-3xl flex flex-col items-center justify-center relative overflow-hidden border border-white/5 shadow-2xl min-h-[250px]">
      ...
      {/* Testo staccato dai bottoni con margini chiari */}
      ...
      <div className="flex gap-3 w-full justify-center">
        <button 
          ...
          className={`flex items-center justify-center gap-2 px-6 py-4 rounded-2xl font-black uppercase tracking-widest text-[10px] transition-all shadow-lg flex-1 max-w-[180px] ${
            isActive ? 'bg-zinc-800 text-zinc-400 border border-white/5' : 'btn-emerald-loading'
          }`}
        >
